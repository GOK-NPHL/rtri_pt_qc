...
Route::post('do-login', [CustomAuthController::class, 'doLogin'])->name('do-login');
Route::get('registration', [CustomAuthController::class, 'registration'])->name('register-user');
Route::post('custom-registration', [CustomAuthController::class, 'customRegistration'])->name('register.custom');
Route::get('logout', [CustomAuthController::class, 'signOut'])->name('signout');


Route::get('/participant-home', 'QC\QCController@participant')->name('participant-home');
Route::get('/admin-home', 'QC\QCController@admin')->name('admin-home');
