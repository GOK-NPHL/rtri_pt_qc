...
class AddLab extends React.Component {
    ...
    //         prevState.mflCode != this.state.mflCode ||
    //         prevState.facilityLevel != this.state.facilityLevel ||
    //         prevState.county != this.state.county ||
    //         prevState.labName != this.state.labName
    ...
    saveLab() {
        ...
        if (
            ...
            (async () => {
                ...
                let response = await SaveParticipant(lab);
